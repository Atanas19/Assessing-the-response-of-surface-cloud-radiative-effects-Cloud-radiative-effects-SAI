...
ax[0].plot(year, SNR_net_WA ,'r-',linewidth=1.5) 
ax[0].plot(year, SNR_sw_WA  ,'k-', linewidth=1.5)
ax[0].plot(year, SNR_lw_WA ,'m-', linewidth=1.5)
ax[0].grid(True, 'major', 'both', ls='--', lw=1, c='k', alpha=.3)

ax[1].plot(year, SNR_net_SA ,'r-',linewidth=1.5) 
ax[1].plot(year, SNR_sw_SA  ,'k-', linewidth=1.5)
ax[1].plot(year, SNR_lw_SA ,'m-', linewidth=1.5)
ax[1].grid(True, 'major', 'both', ls='--', lw=1, c='k', alpha=.3)

ax[2].plot(year, SNR_net_CA ,'r-',linewidth=1.5) 
ax[2].plot(year, SNR_sw_CA  ,'k-', linewidth=1.5)
ax[2].plot(year, SNR_lw_CA ,'m-', linewidth=1.5)
ax[2].grid(True, 'major', 'both', ls='--', lw=1, c='k', alpha=.3)


ax[0].set_ylabel('SNR', fontsize=20, fontweight = 'bold')
ax[1].set_ylabel('SNR', fontsize=20, fontweight = 'bold')
ax[2].set_ylabel('SNR', fontsize=20, fontweight = 'bold')

ax[0].set_xlabel('Year', fontsize=20, fontweight = 'bold')
ax[1].set_xlabel('Year', fontsize=20, fontweight = 'bold')
ax[2].set_xlabel('Year', fontsize=20, fontweight = 'bold')

ax[0].set_title('a) Southern Western Africa', fontsize=20, fontweight = 'bold')
ax[1].set_title('b) Sahara Region', fontsize=20, fontweight = 'bold')
ax[2].set_title('c) Central Africa', fontsize=20, fontweight = 'bold')

ax[2].legend(('NET', 'SW','LW'),loc='best',
          fancybox=True,  shadow=False, ncol=1,prop={'size':15})

# fig.legend(('NET', 'SW','LW'), 
#   loc='upper center',bbox_to_anchor=(0.54,-0.02),
#           fancybox=True,  shadow=False, ncol=5,prop={'size':18})

#plt.savefig("D:/SAI_Data/Signal-to-noise-Ratio-XY.png", dpi=700, bbox_inches='tight')
